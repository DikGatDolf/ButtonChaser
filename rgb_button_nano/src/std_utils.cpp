...
float tmpFloat;
	...
	{
		PrintF("Invalid value for %s - Value must be between %s", name,  floatToStr(min_Limit, 3));
		PrintF(" and %s\n\n", floatToStr(max_Limit, 3));
		return -3;
	}
...
char * floatToStr(float fVal, int decimalpoints)
{
